...
- **PII Corpus Accuracy**: Evaluated on 50 seeded contracts with 94.3% overall recall (100% on regex-based financial/tax/id identifiers, 62% on synthetic person names).
